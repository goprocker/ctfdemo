...
const galleryImages = [
  { src: "/images/gallery-1.png", alt: "Concert performance" },
  { src: "/images/concert-bg.png", alt: "Festival night" },
  { src: "/images/gallery-1.png", alt: "Dance performance" },
  { src: "/images/hero-bg.png", alt: "Cultural showcase" },
  { src: "/images/concert-bg.png", alt: "Music event" },
  { src: "/images/gallery-1.png", alt: "Stage show" },
];
